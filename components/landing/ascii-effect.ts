 ...
 * Ported to three.js by zz85 / https://github.com/zz85
 */
...
export class AsciiEffect {
    ...
    constructor(
        ...
        if (charSet) aCharList = charSet as any;
        ...
        function asciifyImage(oAscii2: any) {
            if (!oCtx || !iWidth || !iHeight || isNaN(iWidth) || isNaN(iHeight)) return;
            ...
            oAscii2.innerHTML =
                "<tr><td style='display:block;width:" +
                width +
                "px;height:" +
                height +
                "px;overflow:hidden'>" +
